        ...
        <div class="modal-content">
            <form action="" method="POST">
                <div class="modal-header border-0">
                    ...
                    <button type="button" onclick="closeModel('all-properties.php')" class="close" data-bs-dismiss="modal" aria-label="Close">
                ...
                <div class="modal-footer border-0">
                    ...
                    <button type="button" class="btn btn-danger" onclick="closeModel('all-properties.php')" data-bs-dismiss="modal">Close</button>
                </div>
            </form>
        </div>
    </div>
