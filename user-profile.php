...
<body>
    <h2 class="heading text-center">Complete Your Property Inquiry</h2>
        ...
        <div class="formbold-form-wrapper">
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="formbold-input-flex">
                    <div>
                        <label for="property-type" class="formbold-form-label"> Property Type </label>
                        <select name="property_type" id="property-type" class="formbold-form-input">
                            <option value="buy" <?= isset($user_data['property_type']) && $user_data['property_type'] == 'buy' ? 'selected' : '' ?>>Buy</option>
                            <option value="rent" <?= isset($user_data['property_type']) && $user_data['property_type'] == 'rent' ? 'selected' : '' ?>>Rent</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="formbold-input-flex">
                    <div>
                        <input type="text" name="firstname" id="firstname" placeholder="Jane" class="formbold-form-input" value="<?= isset($user_data['firstname']) ? htmlspecialchars($user_data['firstname']) : '' ?>" />
                        <label for="firstname" class="formbold-form-label"> First name </label>
                    </div>
                    <div>
                        <input type="text" name="lastname" id="lastname" placeholder="Cooper" class="formbold-form-input" value="<?= isset($user_data['lastname']) ? htmlspecialchars($user_data['lastname']) : '' ?>" />
                ...
                <div class="formbold-input-flex">
                    <div>
                        <input type="email" name="email" id="email" placeholder="jhon@mail.com" class="formbold-form-input" value="<?= isset($user_data['email']) ? htmlspecialchars($user_data['email']) : '' ?>" />
                        <label for="email" class="formbold-form-label"> Email </label>
                    </div>
                    <div>
                        <input type="text" name="phone" id="phone" placeholder="(319) 555-0115" class="formbold-form-input" value="<?= isset($user_data['phone']) ? htmlspecialchars($user_data['phone']) : '' ?>" />
                ...
                <div class="formbold-input-flex">
                    <div>
                        <label for="location" class="formbold-form-label"> Desired Location </label>
                        <input type="text" name="location" id="location" placeholder="Enter location" class="formbold-form-input" value="<?= isset($user_data['location']) ? htmlspecialchars($user_data['location']) : '' ?>" />
                    </div>
                    <div>
                        <label for="budget" class="formbold-form-label"> Budget </label>
                        <input type="text" name="budget" id="budget" placeholder="Enter budget" class="formbold-form-input" value="<?= isset($user_data['budget']) ? htmlspecialchars($user_data['budget']) : '' ?>" />
                    </div>
                </div>

                <!-- Message -->
                <div class="formbold-textarea">
                    <textarea rows="6" name="message" id="message" placeholder="Describe your preferences..." class="formbold-form-input"><?= isset($user_data['message']) ? htmlspecialchars($user_data['message']) : '' ?></textarea>
